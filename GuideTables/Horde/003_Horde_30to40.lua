...
-----------37-38 Dustwallow Marsh
	...
	[3738] = {
		...
		items = {
			...
			[9] = { str = "08) I do the escort quest: #DOQUEST\"Stinky's Escape\"# (starts at 47.18) (grind mobs during this quest)", x = 47, y = 18, zone = "Dustwallow Marsh" },
			[10] = { str = "09) I'll stop at the big raptor spot at 47.17, and grind it clear several times." , x = 47, y = 17, zone = "Dustwallow Marsh" },
			[11] = { str = "10) stop at Brackenwall Village and turn in all quests, accept new ones." },
			[12] = { str = "11) turn in #TURNIN\"Hungry!\"#" },
			[13] = { str = "12) stop back at Jarl's cabin at 55.25, go to the dirt mound once again to get \"#NPCThe Severed Head#\"", x = 55, y = 25, zone = "Dustwallow Marsh" },
			...
			[17] = { str = "16) #DOQUEST\"The Theramore Docks\"# the Captain's Documents are under the water at 71.51" , x = 71, y = 51, zone = "Dustwallow Marsh" },
			...
			--[21] = { str = "20) Kill Deadmire at XX.YY" , x = XX, y = YY, zone = "Dustwallow Marsh" },
